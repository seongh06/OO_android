...
object ContentList {
    val items = listOf(
        ...
        ContentItem(8,true, true, "GDG 모집 중", "안녕하세요! Google Developer Student Clubs 가톨릭대학교 3기 Member를 모집합니다! ", R.drawable.img_example_gdg, "2024-03-03", 1, false),
        ...
        ContentItem(5,true, true, "포롱 모집 중", "교내 본문 5", R.drawable.img_example_content, "2024-05-05", 4, true),
