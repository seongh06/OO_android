...
@AndroidEntryPoint
class AllPromotionListFragment  : BaseFragment<FragmentPostListBinding>(R.layout.fragment_post_list) {
    ...
    companion object {
        fun newInstance(contentItems: List<ContentItem>): AllPromotionListFragment {
            val fragment = AllPromotionListFragment()
    ...
    private fun setupRecyclerView() {
        val promotionItems = ContentList.items.filter {  it.category }
