...
@AndroidEntryPoint
class InSchoolPromotionListFragment  : BaseFragment<FragmentPostListBinding>(R.layout.fragment_post_list) {
    ...
    companion object {
        fun newInstance(contentItems: List<ContentItem>): InSchoolPromotionListFragment {
            val fragment = InSchoolPromotionListFragment()
