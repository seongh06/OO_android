...
class DialogClubRVA(
    private val clubList: MutableList<ClubItem>
    ...
    class ClubViewHolder(private val binding: ItemDialogClubBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(clubItem: ClubItem, position: Int, onAccept: (Int) -> Unit, onReject: () -> Unit) {
            binding.tvDialogClubNameItem.text = clubItem.email
            binding.tvDialogClubNumberItem.text = clubItem.clubName
...
/*
            viewModel.clubReject(removedItem) // ViewModel의 clubReject 호출
*/
